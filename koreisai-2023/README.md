...
今回はWeb Appと言うよりはWebサイトとして作成しているため、デザインが複雑になったり、アドホックにスタイルを変更することが多くなると考えたため、フレームワーク的なものよりもライブラリ的なものを使用したほうが良いと考えたため、vanilla-extractを採用しました。
...
また、Cloudflare Pagesにデプロイされるようになっていて、これによってコミットごとの変化をすぐに確認することができます。
